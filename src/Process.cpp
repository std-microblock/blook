...
namespace blook {
    ...
    void *Process::Allocator::allocate(size_t size, void *nearAddr) {
    ...
    Process::Allocator::Allocator(std::shared_ptr<Process> proc) : proc(proc) {}

    void Process::Allocator::deallocate(void *addr) {
